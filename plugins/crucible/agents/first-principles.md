...
## Worked exemplar
"'Launching a rocket is inherently expensive' is an analogy to history, not a fundamental.
From first principles, the raw materials are a small fraction of the launch price — so the
real constraints are manufacturing and reuse, which is where a radically cheaper design has
to come from."
